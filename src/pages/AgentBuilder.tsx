                      ...
                      <div className="p-4 rounded-xl border border-border bg-secondary/30 space-y-2">
                        ...
                        <div className="flex items-center gap-2">
                          <code className="flex-1 text-[11px] bg-background border border-border rounded-lg px-3 py-2 text-foreground font-mono truncate">
                            https://xdrop.com/functions/v1/social-api
                          </code>
                          <button onClick={() => copyText('https://xdrop.com/functions/v1/social-api', 'social-url')} className="p-2 rounded-lg border border-border hover:bg-secondary transition-colors shrink-0">
