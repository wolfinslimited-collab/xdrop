            ...
            {messages.map((msg, i) => (
              ...
              >
                ...
                <div className={`text-sm leading-relaxed ${
                  ...
                  <div className="prose prose-invert max-w-none text-[15px] leading-[1.75] [&>p]:my-3 [&>ul]:my-3 [&>ol]:my-3 [&>ul]:pl-6 [&>ol]:pl-6 [&_li]:my-1.5 [&_li]:leading-[1.7] [&_strong]:text-foreground [&_strong]:font-semibold [&>p:first-child]:mt-0 [&>p:last-child]:mb-0 [&_code]:bg-secondary [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded-md [&_code]:text-[13px] [&_code]:font-mono [&_code]:border [&_code]:border-border [&_pre]:bg-secondary [&_pre]:rounded-lg [&_pre]:p-4 [&_pre]:border [&_pre]:border-border [&_pre]:my-4 [&>blockquote]:border-l-3 [&>blockquote]:border-accent/40 [&>blockquote]:pl-4 [&>blockquote]:my-4 [&>blockquote]:text-muted-foreground [&>blockquote]:italic [&_h1]:text-xl [&_h1]:font-bold [&_h1]:mt-6 [&_h1]:mb-3 [&_h2]:text-lg [&_h2]:font-bold [&_h2]:mt-5 [&_h2]:mb-2.5 [&_h3]:text-base [&_h3]:font-semibold [&_h3]:mt-4 [&_h3]:mb-2 [&_h4]:text-[15px] [&_h4]:font-semibold [&_h4]:mt-3 [&_h4]:mb-1.5 [&_hr]:my-5 [&_hr]:border-border [&>ul]:list-disc [&>ol]:list-decimal [&_ul_ul]:pl-5 [&_ul_ul]:my-1.5 [&_em]:text-muted-foreground">
